...
package com.victor.markethub.ui.screens.auth
...
import com.victor.markethub.data.AuthViewModel
...
fun LoginScreen(navController: NavController){
    ...
    Column(
        ...
        modifier = Modifier
            .paint(painter = painterResource(R.drawable.products), contentScale = ContentScale.FillBounds)
            .fillMaxSize(),
